...
mylist = [{"name": "Amy", "address": "Apple st 652", "salary": 50000},
...
# Koleksiyona birden çok doküman eklemek
mydocs = collection.insert_many(mylist)
print(mydocs)
print(mydocs.inserted_ids)

# ID'lerini kendimizin verdiği durum
mylist2 = [
...
mydocs = collection.insert_many(mylist2)    # mydocs adında bir instance/nesne oluşturuyorum.
print(mydocs)
print(mydocs.inserted_ids)
